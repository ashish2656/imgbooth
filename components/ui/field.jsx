  ...
  'group/field flex w-full gap-3 data-[invalid=true]:text-destructive',
  {
    variants
      orientation
        ...
        responsive
          'flex-col [&>*]:w-full [&>.sr-only]:w-auto @md/field-group,
          '@md/field-group,
          '@md/field-group,[role=radio]]:mt-px',
        ],
      },
    },
    defaultVariants
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'has-data-[state=checked]:bg-primary/5 has-data-[state=checked]:border-primary dark,
        className,
      )}
      {...props}
    />
